...
Важно понимать: **агент и данные лежат в разных местах.**

```
C:\Users\<ваше имя>\.claude\agents\     ← сам агент: 19 файлов .md
...
- **одни и те же 19 агентов обслуживают все ваши товары** — они ничего
  не помнят между запусками, вся память лежит в папке товара;
- **обновить агента = заменить файл** и перезапустить Claude Code;
- **папка агентов не в репозитории** — при переезде на другой компьютер
  её копируют отдельно.
